(function () {
    ...
    function jhiAlertErrorController($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('neighbournetApiApp.httpError', function (event, httpResponse) {
            var i;
            ...
            switch (httpResponse.status) {
                ...
                case 400:
                    var errorHeader = httpResponse.headers('X-neighbournetApiApp-error');
                    var entityKey = httpResponse.headers('X-neighbournetApiApp-params');
                    if (errorHeader) {
